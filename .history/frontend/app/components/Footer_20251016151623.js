  ...
  return (
    <footer className="bg-black text-gray-400 py-10">
      ...
      <div className="bg-gray-900 text-center py-4 mt-8">
        <p className="text-sm">
          Follow Us: 
          <a href="#" className="ml-2 hover:text-gray-200">Facebook</a> | 
          <a href="#" className="ml-2 hover:text-gray-200">Instagram</a> | 
          <a href="#" className="ml-2 hover:text-gray-200">YouTube</a>
        </p>
      </div>
    </footer>
  );
