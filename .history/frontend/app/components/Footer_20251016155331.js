    ...
    <footer className="bg-black text-gray-400 py-10">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 px-6 text-center md:text-left">
        ...
        <div className="space-y-4">
          ...
          <p className="text-sm">
            <span className="font-semibold">ที่อยู่:</span> 123/45 ถนนสุขภาพดี ตำบลฟิตเนส อำเภอเมือง จังหวัดชุมพร 86120
          </p>
          <p className="text-sm">
            <span className="font-semibold">เบอร์โทร:</span> 02-123-4567 | <span className="font-semibold">อีเมล:</span> contact@fitnest.com
          </p>
          <p className="text-sm">
            <span className="font-semibold">เวลาทำการ:</span> เปิดทุกวัน 9:00 – 18:00 น.
          </p>
        </div>
      </div>
