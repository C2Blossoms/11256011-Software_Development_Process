export default function Footer() {
  return (
    <footer className="bg-black text-gray-400 py-10">
      <div className="container mx-auto flex flex-col items-center space-y-8 px-6 md:items-start md:pl-4">
        {/* Logo */}
        <img src="/path-to-your-logo/logo.png" alt="FitNest Logo" className="w-32 h-auto" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left w-full">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm">
              <span className="font-semibold">Address:</span> Fitnest, Chumphon, Thailand 86120
            </p>
          </div>
        </div>
