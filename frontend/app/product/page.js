      ...
      <div className="relative gap-1 self-center justify-self-center top-0 w-[90%] bg-neutral-600/30 backdrop-blur-s m rounded-[40px] backdrop-opacity-10 border-2">
        <div className="w-[100%] flex justify-evenly justify-self-center h-full select-text">
          <div className="sticky flex flex-col top-0 order-1 ml-10 mt-15 h-80 w-[16%] font-[sans-serif] ">
            <div className="pb-5 font-[sans-serif] text-xl font-[600] text-nowrap drop-shadow-2xl cursor-default ">
              Selection Filter
            </div>
            <span className="font-[sans-serif] text-xl font-[400] text-nowrap drop-shadow-2xl cursor-default ">
              Category
            </span>
          ...
          <div className="flex justify-center cursor-default order-2 mt-15 h-full w-[62%] font-[sans-serif] text-xl font-[600] text-nowrap drop-shadow-2xl">
            Product
          </div>
